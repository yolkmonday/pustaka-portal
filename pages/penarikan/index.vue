<template>
  <div class="bg-white rounded-md py-4">
    <div class="px-4 mb-6 flex justify-between">
      <p class="font-bold">List Penarikan</p>
      <!-- <button class="btn-primary"><i class="fas fa-download"></i> Export Data Penarikan</button>
      <json-excel
        :data="json_data"
        class="hidden"
      >
    ...
    <div class="grid-4 px-4">
      ...
      <div class="flex gap-2">
        ...
        <button
          ...
          @click.prevent="page =1, payload.metode_id = '', payload.status = '', payload.merchant_id = '', penarikan.getData({...payload, mode: ''})"
          ...
          >
            ...
            <td class="p-4">
              <p
                ...
                class="w-max rounded-full px-3 py-1 capitalize"
              >{{ m.status }}</p>
            </td>
